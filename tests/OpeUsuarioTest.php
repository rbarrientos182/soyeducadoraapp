...
class OpeUsuarioTest extends TestCase
{
    ...
    public function testOpeusuarioCreate()
    {
        ...
        $this->put('api/v1/cat_perfil/1/ope_usuario/37', $data)
        ...
        //$this->delete('api/v1/cat_perfil/1/ope_usuario/36')->seeJson(['deleted' => true]);
    }
    ...
    {
      $this->get('api/v1/cat_perfil/1/ope_usuario/35')->seeJsonEquals(['error' => 'Model not found']);
    }*/
